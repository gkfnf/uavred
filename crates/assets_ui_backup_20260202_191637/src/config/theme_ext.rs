...
// Network ACL connection colors
pub const ACL_ALLOW: u32 = 0x10b981;    // Green for allowed connections
pub const ACL_DENY: u32 = 0xef4444;     // Red for denied connections  
pub const ACL_DROP: u32 = 0x6b7280;     // Gray for dropped connections
pub const ACL_UNIDIRECTIONAL: u32 = 0xf59e0b; // Orange for unidirectional
